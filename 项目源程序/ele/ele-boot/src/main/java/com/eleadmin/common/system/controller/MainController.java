...
import com.eleadmin.common.system.param.RegisterParam;
...
import com.eleadmin.common.system.result.RegisterResult;
...
public class MainController extends BaseController {
    ...
    public ApiResult<RegisterResult> register(@RequestBody RegisterParam param, HttpServletRequest request) {
        ...
        if (user == null) {
            ...
            user2.setAvatar("https://cdn.eleadmin.com/20200610/avatar.jpg");

            Role r = new Role();
            r.setUserId(user2.getUserId());
            r.setRoleId(5);
            r.setTenantId(2);
        ...
        String access_token = JwtUtil.buildToken(new JwtSubject(username, tenantId),
                configProperties.getTokenExpireTime(), configProperties.getTokenKey());
        return success("注册成功", new RegisterResult(access_token, user));
