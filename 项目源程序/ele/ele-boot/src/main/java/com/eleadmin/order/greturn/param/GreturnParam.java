package com.eleadmin.order.greturn.param;
...
public class GreturnParam extends BaseParam {
    ...
    private String greturnFullName;

    @ApiModelProperty(value = "机构代码")
    private String greturnCode;

    @ApiModelProperty(value = "机构类型(字典代码)")
    private String greturnType;
    ...
    private String greturnTypeName;
