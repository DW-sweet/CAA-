      ...
      <a-col :lg="12" :md="24" :sm="24" :xs="24">
        <a-card title="基础演示" :bordered="false">
          ...
          <a-space style="margin-bottom: 16px">
            <a-button type="primary" :disabled="!ready1" @click="play">
              播放
            </a-button>
            <a-button type="primary" :disabled="!ready1" @click="pause">
              暂停
            </a-button>
            <a-button type="primary" :disabled="!ready1" @click="replay">
              重新播放
            </a-button>
            <a-button type="primary" :disabled="!ready1" @click="changeSrc">
              切换视频源
            </a-button>
          </a-space>
          <!-- 播放器 -->
        ...
        <a-card title="显示弹幕" :bordered="false">
          ...
          <a-space style="margin-bottom: 16px">
            <a-input
              ...
              :disabled="!ready2"
            />
            <a-button type="primary" :disabled="!ready2" @click="shoot">
              发射
            </a-button>
          </a-space>
          <!-- 播放器 -->
