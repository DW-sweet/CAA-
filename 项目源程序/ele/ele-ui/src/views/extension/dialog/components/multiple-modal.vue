<template>
  <a-card title="同时打开多个弹窗" :bordered="false">
    <a-space>
      <a-button type="primary" @click="openDialog1">打开弹窗1</a-button>
      <a-button type="primary" @click="openDialog2">打开弹窗2</a-button>
      <a-button type="primary" @click="openDialog3">打开弹窗3</a-button>
    </a-space>
