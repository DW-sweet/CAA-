    ...
    <a-row :gutter="16">
      ...
      <a-col :lg="8" :md="24" :sm="24" :xs="24">
        ...
        >
          <template #toolkit>
            <a-space>
              <a-button type="primary" class="ele-btn-icon" @click="moveUp">
                <span><arrow-up-outlined />上移</span>
              </a-button>
              <a-button type="primary" class="ele-btn-icon" @click="moveDown">
                <span><arrow-down-outlined />下移</span>
              </a-button>
              <a-button type="primary" class="ele-btn-icon" @click="moveOut">
      ...
      <a-col :lg="8" :md="24" :sm="24" :xs="24">
        ...
        >
          <template #toolkit>
            <a-button type="primary" class="ele-btn-icon" @click="moveIn">
